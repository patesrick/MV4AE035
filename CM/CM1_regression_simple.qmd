...
* Evaluation
  * 1/2 examen intermédiaire
  * 1/2 examen final

## Ressources

* [Polycopié](https://perso.lpsm.paris/~aguyader/files/teaching/Regression.pdf) de Arnaud Guyader  
...
* [Moodle](https://moodle.u-paris.fr/course/view.php?id=6519)

## GitHub MV4AE035

* https://pbastide.github.io/MV4AE035/

* Dépôt `git`: https://github.com/pbastide/MV4AE035

* Les diapos sont dans `CM`
  * en anglais
...
* Typos et erreurs dans les diapos et fiches
  * k-ème PR accepté = $\frac{1}{2^{k}}$ points en plus sur la note de l'EI.
  * Vaut aussi pour les fiches de vos collègues.
  
* Fiches synthétiques
  * k-ème fiche acceptée (PR) = $\frac{1}{2^{k-1}}$ points en plus sur la note de l'EI.
...
* Integrated in `RStudio` : https://quarto.org/docs/tools/rstudio.html
* `Markdown`
  * Mark up language
  * Easy to learn
...
$$
\hat{\beta}_1 = \sum_{i=1}^n p_i y_i \qquad p_i = \frac{(x_i - \bar{x})}{n \cdot s_{\mathbf{x}}^2}
$$
...
* are **un-correlated** $\to$ (H3): $\mathbb{Cov}[\epsilon_i; \epsilon_j] = 0$
